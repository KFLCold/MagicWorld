...
contract Games is Ownable {
    ...
    constructor () public {
          ...
          metTokenContract = ERC20(0xbF496a476E33e1019F87242CB61468De2532a16b);
          officialAddress = address(0x3D1C4538BBFb21603472dD8c9cF42D885331a730);
          gameSwitchState = false;
          gameOpenPayAmount = 100 * 10 ** 18; // 100 coin
          gameMinPayAmount = 10 * 10 ** 18; // 10 coin
    }
