    ...
    function toInviterRewards(address _sender,uint256 _airdropJoinTotalCount,uint256 _airdropRewardMacAmount) private returns (bool) {
        ...
        for(uint256 i=1;i<=2;i++){
            ...
            if(i==1&&inviter!=address(0)){
                ...
                airdropAccounts[inviter].airdropRewardMacAmount += _airdropRewardMacAmount.mul(10).div(100);
                ...
                airdropAccounts[inviter].airdropRewardMacAmount += _airdropRewardMacAmount.mul(5).div(100);
            }else{
